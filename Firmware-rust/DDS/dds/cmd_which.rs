...
pub enum CmdWhich {
    ...
    /// AUX — Auxiliary Output: reads or writes the DDS daughterboard control byte transmitted on the auxiliary path.
    Aux,
...
impl CmdWhich {
    /// Returns the exact mnemonic transmitted by the legacy DDS protocol.
